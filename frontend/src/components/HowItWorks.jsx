            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-12">
                  <span className="serif text-5xl text-[#1a1715] group-hover:text-[#ff8a3d] transition-colors duration-500">
                    {s.n}
                  </span>
                  <Icon
                    size={22}
                    strokeWidth={1.4}
                    className="text-[#6b6660] group-hover:text-[#ffb070] transition-colors duration-500"
                  />
                </div>
                ...
                {i < steps.length - 1 && (
                  <span className="hidden md:block absolute top-1/2 -right-3 w-5 h-px bg-[#ff8a3d]/40" />
                )}
              </div>
            );
          })}
